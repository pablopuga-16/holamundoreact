...
🔹 React
Es una librería de JavaScript para crear interfaces de usuario, especialmente páginas web dinámicas hechas con componentes.

🔹 Node.js
Es un entorno que permite ejecutar JavaScript fuera del navegador, normalmente en el servidor.
